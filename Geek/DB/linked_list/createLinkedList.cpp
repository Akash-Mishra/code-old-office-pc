// A simple introduction to linked list
#include <iostream>
#include <stdlib.h>
using namespace std;
...
// This function prints contents of a LINKED LIST starting from a given node
...
int main(){
   ...
   Data is random because we haven’t assigned anything yet  */
	...
	head->next = second;  // Link first node with the second data
